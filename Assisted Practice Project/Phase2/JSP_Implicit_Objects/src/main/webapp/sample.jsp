...
<%
        ...
        if (responseCheck != null ) {
                 ...
                 response.setHeader("Location", "response.jsp?office=" + responseCheck);
        }
...
%>
<a href="sample.jsp?office=head_office">Show usage of response object</a><br>
<a href="sample.jsp?error=1">Show usage of error  object</a><br><%
